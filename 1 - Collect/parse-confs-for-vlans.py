...
outfileheadings= [ "sw_vlan_name", "fw_vlan_name", "vlan_id", "vlan_in_DC1", "vlan_in_DC2", "vlan_in_fw", "dc1-sw1_ip", "dc1-sw2_ip", "dc2-sw1_ip", "dc2-sw2_ip", "DC1_vrrp_ip", "DC2_vrrp_ip", "vrrp_ips_match", "fw_vdom", "fw_ip", "vlan_subnet" ]
...
for vlan_id in all_vlan_ids:
    ...
    vrrp_ip_dc1-sw1=vlans["dc1-sw1"]["vlans"][vlan_id]["vlan_vrrp_ip"]
    vrrp_ip_dc1-sw2=vlans["dc1-sw2"]["vlans"][vlan_id]["vlan_vrrp_ip"]
    vrrp_ip_dc2-sw1=vlans["dc2-sw1"]["vlans"][vlan_id]["vlan_vrrp_ip"]
    vrrp_ip_dc2-sw2=vlans["dc2-sw2"]["vlans"][vlan_id]["vlan_vrrp_ip"]

    if vrrp_ip_dc1-sw1!=vrrp_ip_dc1-sw2 or vrrp_ip_dc2-sw1!=vrrp_ip_dc2-sw2:
        print "VRRP IP mismatch!"
        for switch_name in switches:
            print "Switch",switch_name,"vlan",vlan_name,"vrrp_ip",vlans[switch_name]["vlans"][vlan_id]["vlan_vrrp_ip"]
    vrrp_ip_DC1=vrrp_ip_dc1-sw1
    vrrp_ip_DC2=vrrp_ip_dc2-sw1
    ...
    vlan_name_dc1-sw1=vlans["dc1-sw1"]["vlans"][vlan_id]["vlan_name"]
    vlan_name_dc1-sw2=vlans["dc1-sw2"]["vlans"][vlan_id]["vlan_name"]
    vlan_name_dc2-sw1=vlans["dc2-sw1"]["vlans"][vlan_id]["vlan_name"]
    vlan_name_dc2-sw2=vlans["dc2-sw2"]["vlans"][vlan_id]["vlan_name"]
    ...
    if vlan_name_dc1-sw1!="" and vlan_name_dc1-sw1==vlan_name_dc1-sw2:
        vlan_in_DC1="Y"

    if vlan_name_dc2-sw1!="" and vlan_name_dc2-sw1==vlan_name_dc2-sw2:
        vlan_in_DC2="Y"

    if vlan_name_fw!="":
        vlan_in_fw="Y"

    if vlan_name_dc1-sw1!=vlan_name_dc1-sw2 and vlan_name_dc2-sw1==vlan_name_dc2-sw2=="":
        if vlan_name_dc1-sw1=="":
            vlan_in_DC1="dc1-sw2 only"
        elif vlan_name_dc1-sw2=="":
    ...
    if vlan_name_dc2-sw1!=vlan_name_dc2-sw2 and vlan_name_dc1-sw1==vlan_name_dc1-sw2=="":
        if vlan_name_dc2-sw1=="":
            vlan_in_DC2="dc2-sw2 only"
        elif vlan_name_dc2-sw2=="":
    ...
    dc1-sw1_ip=vlans["dc1-sw1"]["vlans"][vlan_id]["vlan_ip"]
    dc1-sw2_ip=vlans["dc1-sw2"]["vlans"][vlan_id]["vlan_ip"]
    dc2-sw1_ip=vlans["dc2-sw1"]["vlans"][vlan_id]["vlan_ip"]
    dc2-sw2_ip=vlans["dc2-sw2"]["vlans"][vlan_id]["vlan_ip"]
    fw_ip=vlans["fw"]["vlans"][vlan_id]["vlan_ip"]
    fw_vdom=vlans["fw"]["vlans"][vlan_id]["vlan_vdom"]

    vlan_ip=""
    vlan_subnet=""
    for ip in [ dc1-sw1_ip, dc1-sw2_ip, dc2-sw1_ip, dc2-sw2_ip, fw_ip ]:
        if ip!="" and ip:
            vlan_ip=ip
            break
    if vlan_ip!="":
    ...
    linelist=[ sw_vlan_name, fw_vlan_name, vlan_id, vlan_in_DC1, vlan_in_DC2, vlan_in_fw, dc1-sw1_ip, dc1-sw2_ip, dc2-sw1_ip, dc2-sw2_ip, vrrp_ip_DC1, vrrp_ip_DC2, vrrp_ips_match, fw_vdom, fw_ip, vlan_subnet ]
